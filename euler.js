...
var _eulerStep = Module['_eulerStep'] = makeInvalidEarlyAccess('_eulerStep');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['eulerStep'] != 'undefined', 'missing Wasm export: eulerStep');
  _eulerStep = Module['_eulerStep'] = createExportWrapper('eulerStep', 4);
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createEulerModule;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = createEulerModule;
} else if (typeof define === 'function' && define['amd'])
  define([], () => createEulerModule);
