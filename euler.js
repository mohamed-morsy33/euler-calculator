...
var _run_euler = Module['_run_euler'] = makeInvalidEarlyAccess('_run_euler');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['run_euler'] != 'undefined', 'missing Wasm export: run_euler');
  _run_euler = Module['_run_euler'] = createExportWrapper('run_euler', 5);
